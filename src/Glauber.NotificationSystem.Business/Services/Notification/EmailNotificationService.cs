...
public class EmailNotificationService(IEmailNotificationRepository notificationRepository) : NotificationService<EmailNotification>(notificationRepository), IEmailNotificationService
{
